...
function ProviderBookingConfirmed() {
...
async function getbookingdata() {
    try {
      ...
      if (data.error) {
        ...
        const confirmedBookings = data.result.filter((booking) => booking.status === "Confirmed");
  ...
  return (
    <>
            <BreadCrumb title=" Confirmed Booking" subTitle="Check bookings" />
...
export default ProviderBookingConfirmed;
