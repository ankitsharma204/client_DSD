...
function ProviderCompletedBookings() {
...
async function getbookingdata() {
    try {
      ...
      if (data.error) {
        ...
        const confirmedBookings = data.result.filter((booking) => booking.status === "Completed");
  ...
  return (
    <>
            <BreadCrumb title=" Completed Booking" subTitle="Check bookings" />
