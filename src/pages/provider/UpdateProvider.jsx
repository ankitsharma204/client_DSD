              ...
              {provider &&
                <table className="table">
                  <tbody>
                    <tr>
                      <td>
                        <h3 style={{ color: 'blue' }}><b>Provider Info</b></h3>
                      </td>
                    ...
                    <tr>
                      <td colSpan={2} className="text-center">
                        <img src={provider.photo ? (Server_URL2 + provider.photo) : '/photo.png'} alt="" style={{ height: 100, borderRadius: 10 }} />
                        <br /><br />
                        <button type="button" className=" btn btn-warning" onClick={handleShow}>Upload <span>   </span> <FiUpload /></button>
                      </td>
                    </tr>
                    <tr>
                      <th className="text-end" style={{ color: 'blue' }}>Provider :</th>
                      <td style={{ color: 'blue' }}>{provider.fullname}</td>
                    </tr>
                    <tr>
                      <th className="text-end" style={{ color: 'blue' }}>Slot Amount :</th>
                      <td style={{ color: 'blue' }}>{provider.SlotAmount}</td>
                    </tr>
                    <tr>
                      <th className="text-end" style={{ color: 'blue' }}>Status :</th>
                      <td style={{ color: 'blue' }}>{provider.status}</td>
                    </tr>
                  </tbody>
                </table>
              }
